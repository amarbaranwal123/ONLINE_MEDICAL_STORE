...
function component10($productname, $productprice, $productimg, $productid){
	$element = "
	<div class=\"col-md-3 col-sm-6 my-3 my-md-0\">
			<form action=\"mask.php\" method=\"post\">
...
function cartElement10($productimg, $productname, $productprice, $productid){
	$element="
