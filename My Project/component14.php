...
function component14($productname, $productprice, $productimg, $productid){
	$element = "
	<div class=\"col-md-3 col-sm-6 my-3 my-md-0\">
			<form action=\"cold.php\" method=\"post\">
...
function cartElement14($productimg, $productname, $productprice, $productid){
	$element="
