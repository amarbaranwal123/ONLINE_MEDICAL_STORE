...
function component17($productname, $productprice, $productimg, $productid){
	$element = "
	<div class=\"col-md-3 col-sm-6 my-3 my-md-0\">
			<form action=\"stomach.php\" method=\"post\">
				<div class=\"card shadow\">
					...
					<div class=\"card-body\">
						...
						<h5>
							<small><s class=\"text-secondary\"><i class=\"fa fa-inr\"></i>135</s></small>
...
function cartElement17($productimg, $productname, $productprice, $productid){
	$element="
					...
					<div class=\"border rounded\">
						<div class=\"row bg-white\">
							...
							<div class=\"col-md-6\">
								...
								<small class=\"text-secondary\">Seller:Himanshu</small>
