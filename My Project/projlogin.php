...
<head>
	...
	<link rel="stylesheet" type="text/css" href="projlogin.css">
...
<body>
	...
	<div class="container">
        ...
        <div class="border">
       	<div class="bg">	 	
		<div class="form1">        
         <form action="login1.php" onsubmit="return validation()" method="post">
         	
		    	<h1>Log !n</h1>
		    	<br>
		    	<input  type="text" id="email" name="FirstName" placeholder="Username"><br><b><span class="formerror" id="user"></span></b><br>

		    	<input type="password" id="pass" name="Password" placeholder="Enter Password " ><br><b><span class="formerror" id="password"></span></b><br>

		    	<input type="checkbox" id="remem">Remember password<br><br>

		    	<input type="submit" id="sign" value="Submit"><br><br>

                <a style="margin-left: 10px"  href="#"> Forget Password ?</a>
                <a style="margin-left: 40px"  href="reg3.php"> Don't have an account ?</a>
	...
	<script>
		...
		if(username==""){
			 document.getElementById('user').innerHTML = "** Please enter your email address..";
            return false;
		}
